# Issue Evaluation Prompt Templates

This document contains prompt templates used to evaluate proposed GitHub Issues
...
2. The suggested description is pasted into one of the prompts below.
...
## PowerShell Style Guide Prompt

Use this prompt when evaluating a proposed issue for this repository
(PSStyleGuide) or any other PowerShell-focused style guide repository.

``````markdown
A PowerShell expert suggested I create the following GitHub Issue. Please read `STYLE_GUIDE.md`, then evaluate the proposed GH Issue description and tell me if it should be changed:

`````markdown
Paste the Claude-suggested prompt here.
`````
...
## Generic Style Guide Prompt

Use this prompt when evaluating a proposed issue for a non-PowerShell style
guide repository (e.g., TerraformStyleGuide).
